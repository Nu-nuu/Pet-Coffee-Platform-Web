...
export default function CreateShopManager() {
    ...
    return (
        <div className="createShopManager">
            <Header
                title="Tạo cửa hàng"
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={5}>
                        {/* shopType */}
                        <FormControl sx={{ m: 1 }} style={{ width: "97%" }}>
                            <InputLabel id="shopType" color="secondary">
                                <span>
                                    Loại Cửa Hàng{" "}
                                    <span style={{ color: "red" }}>*</span>
                                </span>
                            ...
                            <Select
                                ...
                                color="secondary"
                            >
                                <MenuItem value={""}>Loại Cửa Hàng</MenuItem>
                                <MenuItem value={"Cat"}>Cà Phê Mèo</MenuItem>
                                <MenuItem value={"Dog"}>Cà Phê Chó</MenuItem>
                                <MenuItem value={"CatAndDog"}>
                                    Cà Phê Chó Và Mèo
                                </MenuItem>
                            </Select>
                        </FormControl>
                ...
                <>
                    ...
                    <div className="map-container">
                        ...
                        <div className="location">{formik.values.location}</div>
                    </div>
